...
<body class="d-flex flex-column min-vh-100">
    ...
    <div class="container my-5">
        ...
        <?php } else {
            echo '<div class="alert alert-success">Étape 1 validée.</div>';
            $step1 = true;
        } ?>
        ...
        <?php } else {
            echo '<div class="alert alert-success">Étape 2 validée.</div>';
            $step2 = true;
        } ?>
        ...
        <?php } else {
            echo '<div class="alert alert-success">Étape 4 validée.</div>';
            $step4 = true;
        } ?>
