        ...
        <div class="card-body">
          ...
          <div class="btn-group" role="group">
            <?php if (isset($_SESSION['auth']) and $_SESSION['grade'] != 0) { ?>
              ...
              <a href="gestion/emprunt.php?id=<?= htmlspecialchars($booksInfos['id']); ?><?php if ($booksInfos['statut'] == 1) {
                                                                                            echo '&user_id=' . htmlspecialchars($emprunt['id_emprunteur']);
                                                                                          } ?>" class="btn btn-success">Emprunt</a>
            <?php } ?>
          </div>
        </div>
      </div>
