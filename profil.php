...
<body class="d-flex flex-column min-vh-100">
  ...
  <?php if ($selectInfosFromUsers->rowCount() === 1) { ?>
    <?php if ($usersInfos['nb_emprunt'] == 1) {
      $emprunts = 'emprunt';
    } else {
      $emprunts = 'emprunts';
    } ?>
    <div class="container mt-3">
      <div class="d-flex justify-content-center mt-4">
        <div class="card text-center mb-3" style="width: 50rem;">
          <div class="card-body">
            <h5 class="card-title"><?= htmlspecialchars($usersInfos['prenom']); ?> <?= htmlspecialchars($usersInfos['nom']); ?></h4>
            </h5>
  ...
  <?php } else {
    echo 'Aucun utilisateur avec l\'id n°' . htmlspecialchars($_GET['id']) . ' n\'a été trouvé.';
  } ?>
