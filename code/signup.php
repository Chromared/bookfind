...
<form method="POST" class="form">
    ...
    <label class="form-label">Nom : </label><input type="text" maxlength="50" name="name" required="required" class="form-control"/>
    <br /><label class="form-label">Prénom : </label><input type="text" maxlength="25" name="firstname" required="required" class="form-control"/>
    ...
    <br /><label class="form-label">Numéro de carte : </label><input value="<?php if(isset($_GET['card'])){echo $_GET['card'];}?>" type="number" maxlength="8" max="99999999" required="required" name="card" class="form-control"/>
    ...
    <br /><label class="form-label">Je confirme avoir lu et accepté-e le <a href="rules.php" target="_blank">réglement</a> et la <a href="pdc.php" target="_blank">politique de confidentialité</a> : </label><input required="required" type="checkbox" name="rules-pdc"/>
