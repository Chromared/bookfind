...
<form method="POST" class="form">
    ...
    <br /><label class="form-label">Numéro de carte : </label><input value="<?php if(isset($_GET['card'])){echo $_GET['card'];}?>" type="number" required="required" name="card" class="form-control"/>
    ...
    <br /><label class="form-label">Je confirme avoir lu et accepté-e le <a href="rules.php" target="_blank">réglement</a> et la <a href="pdc.php" target="_blank">politique de confidentialité</a> : </label><input required="required" class="form-checkbox" type="checkbox" name="rules-pdc"/>
