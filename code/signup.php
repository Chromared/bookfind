...
<form method="POST" class="form">
    ...
    <label class="form-label">Nom : </label><input type="text" maxlength="50" name="name" class="form-control"/>
    <br /><label class="form-label">Prénom : </label><input type="text" maxlength="25" name="firstname" class="form-control"/>
    <br /><label class="form-label">Mot de passe : </label><input type="password" name="password" class="form-control"/>
    <br /><label class="form-label">Confirmer le mot de passe : </label><input type="password" name="confirm_password" class="form-control"/>
    <br /><label class="form-label">Numéro de carte : </label><input value="<?php if(isset($_GET['card'])){echo $_GET['card'];}?>" type="number" name="card" class="form-control"/>
    ...
    <br /><label class="form-label">Je confirme avoir lu et accepté-e le <a href="rules.php" target="_blank">réglement</a> et la <a href="pdc.php" target="_blank">politique de confidentialité</a> : </label><input class="form-checkbox" type="checkbox" name="rules-pdc"/>
