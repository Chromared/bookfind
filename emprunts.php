      ...
      <div class="d-flex justify-content-center mt-4">
        <ul class="nav nav-tabs" id="myTab" role="tablist">
          <li class="nav-item" role="presentation">
            <button class="nav-link <?php if($nbRetards > 0){ echo 'active'; } ?>" id="retard-tab" data-bs-toggle="tab" data-bs-target="#retard" type="button" role="tab" aria-controls="retard" aria-selected="<?php if($nbRetards > 0){ echo 'true'; }else{ echo 'false'; } ?>" <?php if($nbRetards == 0){ echo 'disabled'; } ?>>En retard <span class="badge text-bg-secondary"><?= $nbRetards ?></span></button>
          </li>
          <li class="nav-item" role="presentation">
