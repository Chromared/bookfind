                      ...
                      <div class="d-flex justify-content-center mt-4">
                        <div class="card text-center" style="width: 50rem;">
                          <div class="card-body">
                            ...
                            <?php if($_SESSION['grade'] == 1){ ?><a href="emprunt.php?id=<?= htmlspecialchars($recupBooks['id']); ?><?php if($recupBooks['statut'] == 1){ echo '&user_id=' . htmlspecialchars($empruntsInfos1['id_emprunteur']); } ?>" class="btn btn-success">Emprunt</a><?php } ?>
                            </div>
                          </div>
                        </div>
                      </div>
                      ...
                      <div class="d-flex justify-content-center mt-4">
                        <div class="card text-center" style="width: 50rem;">
                          <div class="card-body">
                            ...
                            <div class="btn-group" role="group">
                            <a href="books-reader.php?id=<?= htmlspecialchars($recupBooks['id']); ?>" class="btn btn-secondary">Voir</a>
                            <?php if($_SESSION['grade'] == 1){ ?><a href="emprunt.php?id=<?= htmlspecialchars($recupBooks['id']); ?><?php if($recupBooks['statut'] == 1){ echo '&user_id=' . htmlspecialchars($empruntsInfos2['id_emprunteur']); } ?>" class="btn btn-success">Emprunt</a><?php } ?>
                            </div>
                          </div>
                        </div>
                      </div>
                      ...
                      <div class="d-flex justify-content-center mt-4">
                        <div class="card text-center" style="width: 50rem;">
                          <div class="card-body">
                            ...
                            <div class="btn-group" role="group">
                            <a href="books-reader.php?id=<?= htmlspecialchars($recupBooks['id']); ?>" class="btn btn-secondary">Voir</a>
                            <?php if($_SESSION['grade'] == 1){ ?><a href="emprunt.php?id=<?= htmlspecialchars($recupBooks['id']); ?><?php if($recupBooks['statut'] == 1){ echo '&user_id=' . htmlspecialchars($empruntsInfos3['id_emprunteur']); } ?>" class="btn btn-success">Emprunt</a><?php } ?>
                            </div>
                          </div>
                        </div>
                      </div>
...
<?php }else{die('Absence de l\'ID de l\'emprunteur');} ?>
</div>
</body>
</html>