                      ...
                      <div class="d-flex justify-content-center mt-4">
                        <div class="card text-center" style="width: 50rem;">
                          <div class="card-body">
                            ...
                            <?php if($_SESSION['grade'] == 1){ ?><a href="emprunt.php?id=<?= htmlspecialchars($recupBooks['id']); ?><?php if($recupBooks['statut'] == 1){ echo '&card=' . htmlspecialchars($empruntsInfos1['card_emprunteur']); } ?>" class="btn btn-success">Emprunt</a><?php } ?>
                            </div>
                          </div>
                        </div>
                      </div>
                      ...
                      <div class="d-flex justify-content-center mt-4">
                        <div class="card text-center" style="width: 50rem;">
                          <div class="card-body">
                            ...
                            <div class="btn-group" role="group">
                            <a href="books-reader.php?id=<?= htmlspecialchars($recupBooks['id']); ?>" class="btn btn-secondary">Voir</a>
                            <?php if($_SESSION['grade'] == 1){ ?><a href="emprunt.php?id=<?= htmlspecialchars($recupBooks['id']); ?><?php if($recupBooks['statut'] == 1){ echo '&card=' . htmlspecialchars($empruntsInfos2['card_emprunteur']); } ?>" class="btn btn-success">Emprunt</a><?php } ?>
                            </div>
                          </div>
                        </div>
                      </div>
                      ...
                      <div class="d-flex justify-content-center mt-4">
                        <div class="card text-center" style="width: 50rem;">
                          <div class="card-body">
                            ...
                            <div class="btn-group" role="group">
                            <a href="books-reader.php?id=<?= htmlspecialchars($recupBooks['id']); ?>" class="btn btn-secondary">Voir</a>
                            <?php if($_SESSION['grade'] == 1){ ?><a href="emprunt.php?id=<?= htmlspecialchars($recupBooks['id']); ?><?php if($recupBooks['statut'] == 1){ echo '&card=' . htmlspecialchars($empruntsInfos3['card_emprunteur']); } ?>" class="btn btn-success">Emprunt</a><?php } ?>
                            </div>
                          </div>
                        </div>
                      </div>
