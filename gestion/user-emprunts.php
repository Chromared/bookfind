...
<body class="d-flex flex-column min-vh-100">
                ...
                <div class="card text-center" style="width: 50rem;">
                  <div class="card-body">
                    ...
                    <div class="btn-group" role="group">
                      ...
                      <?php if ($_SESSION['grade'] == 1) { ?><a href="emprunt.php?id=<?= htmlspecialchars($recupBooks['id']); ?><?php if ($recupBooks['statut'] == 1) {
  ...
  <?php } else {
    die('Absence de l\'ID de l\'emprunteur');
  } ?>
  </div>
