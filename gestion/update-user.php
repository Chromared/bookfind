...
<?php if(($_SESSION['grade'] != '1' AND $usersInfos['grade'] == '1') OR ($_SESSION['grade'] != '1' AND $_SESSION['grade'] != '2' AND $usersInfos['grade'] == '2') OR $_SESSION['grade'] == '3' OR $_SESSION['grade'] == '0'){echo '<p>Vous n\'avez pas le droit de modifier cet utilisateur.</p>';}else{ ?>
